...
export const createCareRecipient = async (
  ...
  try {
    if (!groupId || !userId) {
      throw new Error(
        "groupId and userId are required to create a care recipient"
      );
    }
...
export const getCareRecipientById = async (careRecipientId) => {
  try {
    ...
    const recipient = await CareRecipient.findById(careRecipientId).populate(
      "userId",
      "firstName lastName"
    );
...
export const getCareRecipientsByGroupId = async (groupId) => {
  try {
    ...
    throw new Error(
      "Error fetching care recipients by groupId: " + error.message
    );
  }
};
...
export const getCareRecipientsByUserId = async (userId) => {
  try {
    ...
    throw new Error(
      "Error fetching care recipients by userId: " + error.message
    );
  }
};
...
export const getCareRecipientsByPrimaryCondition = async (condition) => {
  try {
    ...
    throw new Error(
      "Error fetching care recipients by primary condition: " + error.message
    );
  }
};
...
export const getCareRecipientsWithEmergencyContacts = async () => {
  try {
    ...
    throw new Error(
      "Error fetching care recipients with emergency contacts: " + error.message
    );
  }
};
...
export const getCareRecipientsByDOBRange = async (startDate, endDate) => {
  try {
    ...
    throw new Error(
      "Error fetching care recipients by DOB range: " + error.message
    );
  }
};

//Update Care Recipient Emergency Contacts
export const updateCareRecipientEmergencyContacts = async (
  careRecipientId,
  emergencyContacts
) => {
  try {
    ...
    throw new Error(
      "Error updating care recipient emergency contacts: " + error.message
    );
  }
};
...
export const getCareRecipientsByNoteKeyword = async (keyword) => {
  try {
    ...
    throw new Error(
      "Error fetching care recipients by note keyword: " + error.message
    );
  }
};
...
export const getCareRecipientsByMultipleConditions = async (conditions) => {
  try {
    ...
    throw new Error(
      "Error fetching care recipients by multiple conditions: " + error.message
    );
  }
};
...
export const getCareRecipientsByAgeRange = async (minAge, maxAge) => {
  try {
    ...
    throw new Error(
      "Error fetching care recipients by age range: " + error.message
    );
  }
};

//Get Care Recipients by Group and Condition
export const getCareRecipientsByGroupAndCondition = async (
  groupId,
  condition
) => {
  try {
    ...
    if (!recipients || recipients.length === 0) {
      throw new Error(
        "No care recipients found for this group with the given condition"
      );
    }
    return recipients;
  } catch (error) {
    throw new Error(
      "Error fetching care recipients by group and condition: " + error.message
    );
  }
};
...
export const getCareRecipientsByUserName = async (userName) => {
  try {
    ...
    const recipients = await CareRecipient.find().populate({
      path: "userId",
    ...
    throw new Error(
      "Error fetching care recipients by user name: " + error.message
    );
  }
};
