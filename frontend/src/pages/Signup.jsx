                    ...
                    <div className="flex flex-col items-center justify-center px-12 relative text-center text-white w-full z-10">
                        <div className="flex flex-col items-center justify-center px-12 relative text-center text-white w-full z-10 mb-12">
                            ...
                            <p className="text-lg text-indigo-100 max-w-md mx-auto py-4">
                                ...
                                one place. Join thousands of families already using CareConnect.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4 text-left max-w-md">
                            <div className="flex items-center gap-3 py-4">
                                ...
                                <span className="text-indigo-100">Seamless care coordination</span>
                            </div>
                            <div className="flex items-center gap-3 py-4">
                                <div className="flex-shrink-0 w-8 h-8 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center">
                                    <svg
                            ...
                            <div className="flex items-center gap-3 py-4">
                                ...
                                <span className="text-indigo-100">Secure and private platform</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-md w-full mx-auto px-4 md:p-4 lg:px-0">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 py-4">
                                ...
                                <Link to='/signin' className="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors"
                                > Sign in
                                </Link>
                                <a
                                    href="/login"
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex items-start gap-2 py-4">
                                <div className="flex items-center h-5 py-4">
                                    <input
                                        id="terms"
                                        name="terms"
                                        type="checkbox"

                                        className="h-4 py-4 w-4 rounded border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-0 cursor-pointer"
                                    />
                                </div>
                                <label
                                    htmlFor="terms"
                            ...
                            <button
                                type="submit"
                                className="w-full mt-3 bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600 text-white font-semibold py-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl"
                            >
                                Create account
                            </button>
                        </form>
