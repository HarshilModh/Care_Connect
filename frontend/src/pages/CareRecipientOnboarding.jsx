...
const CareRecipientOnboarding = () => {
    ...
    const validateForm = () => {
        ...
        if (!primaryCondition.trim()) {
            toast.error("Please enter the primary medical condition");
            return false;
        }
        ...
        if (!emergencyPhone.trim()) {
            toast.error("Please enter an emergency contact phone");
            return false;
        }

        if (!emergencyRelation.trim()) {
            toast.error("Please enter the relation of the emergency contact");
            return false;
        }
